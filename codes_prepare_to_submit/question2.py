...
def search(values):
    ...
    # Deactivate the 3rd criterion which chooses the box with the fewest possibilities below the line 
    # and replace it with #choosing a box and a number at random
